...
data_path = "paper_data/train_target_permute_segment_temp.txt"
sample_data_path = "paper_data/sample_text_temp.txt"
debug_data_path = "paper_data/debug_text_temp.txt"
size = 16
